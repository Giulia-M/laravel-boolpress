...
<div class="row justify-content-center">
  <div class="col-12">
    ...
    @foreach ($posts as $post)
      <div>
        <img src="{{ $post->cover_url ? asset('storage/' . $post->cover_url) : 'https://www.linga.org/site/photos/Largnewsimages/image-not-found.png'}}" class="img-fluid rounded-start" alt="..." >
      </div>
